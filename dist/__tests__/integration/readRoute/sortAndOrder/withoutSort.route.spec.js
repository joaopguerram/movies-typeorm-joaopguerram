...
describe('Tests on route: GET /movies. Must be able to list all movies.', () => {
    ...
    it("Query parameters: 'order' equals 'asc' and without 'sort'", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).get(baseUrl + '?order=asc');
        const expectResults = {
            status: 200,
            bodyToEqual: readRoutePaginationMocks.paginationPagePerPage.default,
        };
    ...
    it("Query parameters: 'order' equals 'desc' and without 'sort'", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).get(baseUrl + '?order=desc');
        const expectResults = {
            status: 200,
            bodyToEqual: readRoutePaginationMocks.paginationPagePerPage.default,
        };
